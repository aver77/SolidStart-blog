...
export const PostCard: Component<IPostCardWithSubtitleClass> = ({ wrapperClass, subtitleClass, ...post }) => {
    ...
    return (
        ...
        >
            ...
            <h2 class={cx("my-offset3x text-ellipsis overflow-hidden", subtitleClass)}>{subTitle}</h2>
